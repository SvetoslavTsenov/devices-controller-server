...
import { IDevice } from "devices-controller";
export declare class DeviceManager {
    ...
    private static loadDBWithAndroidDevices(model);
    private static loadDBWithIOSDevices(model);
    private static createModel(model, device);
}
